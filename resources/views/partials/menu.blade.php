    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route("admin.pengusahas.index") }}" class="nav-link {{ request()->is("admin/pengusahas") || request()->is("admin/pengusahas/*") ? "active" : "" }}">
                        <i class="fa-fw nav-icon fas fa-user-tie">

                        </i>
                        <p>
                            {{ trans('cruds.pengusaha.title') }}
                        </p>
                    </a>
                </li>
                @endcan
                @can('dokumentasi_access')
                <li class="nav-item">
                    <a href="{{ route("admin.dokumentasis.index") }}" class="nav-link {{ request()->is("admin/dokumentasis") || request()->is("admin/dokumentasis/*") ? "active" : "" }}">
                        <i class="fa-fw nav-icon far fa-images">

                        </i>
                        <p>
                            {{ trans('cruds.dokumentasi.title') }}
                        </p>
                    </a>
                </li>
                @endcan
